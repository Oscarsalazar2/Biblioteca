...
@section('content')
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-blue-800">
                            Biblioteca<span class="text-blue-500">Digital</span>
                        </h1>
                ...
                <nav class="hidden lg:block">
                    <ul class="flex space-x-8 items-center">
                        <li>
                            <a href="#inicio"
                               class="text-blue-800 font-semibold hover:text-blue-600 transition-all border-b-2 border-blue-800 pb-1">
                        ...
                        <li>
                            <a href="{{ route('login') }}"
                               class="bg-blue-700 hover:bg-blue-800 text-white px-5 py-2 rounded-lg font-medium transition-all ml-4 glow">
                ...
                <button id="menu-toggle" class="lg:hidden text-blue-800 focus:outline-none" aria-label="Abrir menú">
            ...
            <div id="mobile-menu" class="hidden lg:hidden mt-4 pb-2">
                <ul class="space-y-3">
                    ...
                    <li class="pt-2 border-t border-gray-200">
                        <a href="#login"
                           class="block py-3 px-4 bg-blue-700 text-white text-center rounded-lg font-medium glow">
                            <i class="fas fa-sign-in-alt mr-2"></i>Iniciar Sesión
                        </a>
                    </li>
                </ul>
    ...
    <section id="inicio" class="relative overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img
                ...
                alt="Biblioteca con libros y estantes"
                class="h-full w-full object-cover"
                loading="lazy"
            />
            <div class="absolute inset-0 bg-blue-950/65"></div>
            <div class="absolute inset-0 bg-linear-to-r from-blue-950/70 via-blue-900/55 to-blue-800/45"></div>

            <div class="absolute -top-24 -right-24 h-80 w-80 rounded-full bg-blue-400/15 blur-3xl"></div>
            <div class="absolute -bottom-24 -left-24 h-80 w-80 rounded-full bg-indigo-400/15 blur-3xl"></div>
        </div>
        ...
        <div class="container mx-auto px-4 py-16 md:py-24 relative z-10">
            <div class="max-w-3xl mx-auto text-center text-white">
                ...
                <p class="text-xl md:text-2xl mb-8 opacity-95">
                    Accede a miles de libros, recursos digitales y servicios culturales desde cualquier lugar.
                </p>

                <div class="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6 mb-10">
                    <a href="#explorar"
                       class="bg-white text-blue-900 hover:bg-blue-50 font-bold py-4 px-8 rounded-lg text-lg transition-all transform hover:-translate-y-1 pulse-animation glow">
                        <i class="fas fa-search mr-2"></i>Explorar Catálogo
                    </a>
                    <a href="{{ route('registro') }}"
                       class="bg-transparent border-2 border-white/90 text-white hover:bg-white hover:text-blue-900 font-bold py-4 px-8 rounded-lg text-lg transition-all">
                        <i class="fas fa-user-plus mr-2"></i>Registrarse Gratis
                    </a>
                </div>

                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
                    <div class="bg-slate-950/45 border border-white/15 p-4 rounded-lg backdrop-blur-sm custom-shadow">
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Ofrecemos una amplia gama de servicios para satisfacer las necesidades de lectores, investigadores y amantes del conocimiento.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <article class="bg-white rounded-xl custom-shadow p-6 transition-all hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 mb-4">
                        Accede a nuestro amplio catálogo físico y digital. Préstamos por 15 días con posibilidad de renovación.
                    </p>
                ...
                <article class="bg-white rounded-xl custom-shadow p-6 transition-all hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 mb-4">
                        Biblioteca virtual con acceso a revistas académicas, libros electrónicos, bases de datos y más.
                    </p>
                ...
                <article class="bg-white rounded-xl custom-shadow p-6 transition-all hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 mb-4">
                        Club de lectura, talleres de escritura, charlas con autores y actividades para todas las edades.
                    </p>
    ...
    <section class="py-16 bg-gray-50" id="catalogo">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-blue-800 mb-4">Libros Destacados</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Descubre nuestras últimas adquisiciones y las obras más populares entre nuestros lectores.
                </p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-xl custom-shadow overflow-hidden transition-all hover:-translate-y-2">
                    <div class="h-48 bg-linear-to-r from-blue-500 to-blue-700 flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl custom-shadow overflow-hidden transition-all hover:-translate-y-2">
                    <div class="h-48 bg-linear-to-r from-green-500 to-green-700 flex items-center justify-center">
                        <i class="fas fa-book text-white text-6xl opacity-80"></i>
                    </div>
                    <div class="p-5">
                ...
                <div class="bg-white rounded-xl custom-shadow overflow-hidden transition-all hover:-translate-y-2">
                    <div class="h-48 bg-linear-to-r from-purple-500 to-purple-700 flex items-center justify-center">
                        <i class="fas fa-book text-white text-6xl opacity-80"></i>
                    </div>
                    <div class="p-5">
                ...
                <div class="bg-white rounded-xl custom-shadow overflow-hidden transition-all hover:-translate-y-2">
                    <div class="h-48 bg-linear-to-r from-yellow-500 to-yellow-700 flex items-center justify-center">
                        <i class="fas fa-book text-white text-6xl opacity-80"></i>
                    </div>
                    <div class="p-5">
            ...
            <div class="text-center mt-10">
                <a href="#catalogo"
                   class="inline-flex items-center bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-8 rounded-lg transition-all glow">
    ...
    <section class="py-16 bg-white" id="eventos">
        <div class="container mx-auto px-4">
                ...
                <div class="bg-blue-50 rounded-2xl p-8 md:p-10 custom-shadow">
                    <div class="flex flex-col md:flex-row items-center">
                        <div class="md:w-1/4 mb-6 md:mb-0">
                            <div class="w-32 h-32 rounded-full bg-linear-to-r from-blue-500 to-blue-700 flex items-center justify-center mx-auto custom-shadow">
                        ...
                        <div class="md:w-3/4 md:pl-10">
                            ...
                            <p class="text-lg md:text-xl text-gray-700 mb-6 italic">
                                "Como estudiante de literatura, la Biblioteca Digital ha sido un recurso invaluable para mi investigación.
                                La variedad de libros electrónicos y la facilidad para reservar materiales físicos han transformado completamente mi forma de estudiar."
                            </p>
                            <div>
                                <h4 class="font-bold text-blue-800 text-lg">Ximena Amador Morante</h4>
                                <p class="text-gray-600">Estudiante de Ing. Sistemas Computacionales, Miembro desde 2022</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 bg-linear-to-r from-blue-800 to-blue-600 text-white" id="registro">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl md:text-4xl font-bold mb-6">¿Listo para comenzar tu viaje literario?</h2>
                <p class="text-xl mb-10 opacity-90">
                    Regístrate gratis y obtén acceso inmediato a miles de recursos digitales y todos los servicios de nuestra biblioteca.
                </p>

                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                    <a href="{{ route('registro') }}"
                       class="bg-white text-blue-800 hover:bg-blue-50 font-bold py-4 px-10 rounded-lg text-lg transition-all transform hover:scale-105 glow">
                        <i class="fas fa-user-plus mr-2"></i>Crear Cuenta Gratis
                    </a>
                    <a href="#tour"
                       class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-800 font-bold py-4 px-10 rounded-lg text-lg transition-all">
    ...
    <footer class="bg-gray-900 text-white pt-12 pb-6" id="contacto">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
                <div>
                    <div class="flex items-center space-x-3 mb-6">
                        <div class="w-10 h-10 rounded-lg bg-blue-600 flex items-center justify-center custom-shadow">
                            <i class="fas fa-book-open text-white text-xl"></i>
                        </div>
                        <div>
                    ...
                    <p class="text-gray-400 mb-6">
                        Promoviendo la lectura, el conocimiento y la cultura desde 1995. Tu acceso gratuito al mundo de las ideas.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-400">
                        <li class="flex justify-between"><span>Lunes a Viernes</span><span class="font-medium">8:00 - 20:00</span></li>
                        <li class="flex justify-between"><span>Sábados</span><span class="font-medium">9:00 - 18:00</span></li>
                        <li class="flex justify-between"><span>Domingos</span><span class="font-medium">10:00 - 14:00</span></li>
                    </ul>
                ...
                <div>
                    ...
                    <div class="mt-6">
                        <a href="#newsletter" class="inline-flex items-center bg-blue-700 hover:bg-blue-800 text-white py-3 px-5 rounded-lg transition-all glow">
