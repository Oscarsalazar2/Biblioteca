...
<head>
  ...
  <style>
    ...
    /* Sombra suave tipo “pro” */
    .custom-shadow{
      box-shadow: 0 10px 30px rgba(2, 6, 23, .08);
    }

    /* Botón con glow sutil */
    .glow{
    ...
    /* Micro-animación para CTA */
    @keyframes pulseSoft {
      0%,100%{ transform: translateY(0); box-shadow: 0 16px 34px rgba(29, 78, 216, .18); }
      50%{ transform: translateY(-2px); box-shadow: 0 22px 42px rgba(29, 78, 216, .26); }
    }
    .pulse-animation{ animation: pulseSoft 2.8s ease-in-out infinite; }
  </style>
</head>
...
<body class="bg-gray-50">
      ...
      <div class="flex justify-between items-center">
        ...
        <nav class="hidden md:block">
          <ul class="flex space-x-8 items-center">
            ...
            <li>
              <a href="#login" class="bg-blue-700 hover:bg-blue-800 text-white px-5 py-2 rounded-lg font-medium transition-all ml-4 glow">
      ...
      <div id="mobile-menu" class="hidden md:hidden mt-4 pb-2">
        <ul class="space-y-3">
          ...
          <li class="pt-2 border-t border-gray-200">
            <a href="#login" class="block py-3 px-4 bg-blue-700 text-white text-center rounded-lg font-medium glow">
              <i class="fas fa-sign-in-alt mr-2"></i>Iniciar Sesión
            </a>
          </li>
        </ul>
  ...
  <!-- Sección Hero (MISMO layout, ahora con imagen real) -->
  <section id="hero" class="relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
      ...
      <div class="absolute inset-0 bg-gradient-to-r from-blue-950/70 via-blue-900/55 to-blue-800/45"></div>
    ...
    <div class="absolute bottom-0 left-0 right-0">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="w-full">
        <path fill="#ffffff" fill-opacity="1"
          d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,112C672,96,768,96,864,112C960,128,1056,160,1152,160C1248,160,1344,128,1392,112L1440,96L1440,320L0,320Z"></path>
      </svg>
    </div>
  </section>
  ...
  <section class="py-16 bg-gray-50" id="catalogo">
    <div class="container mx-auto px-4">
      ...
      <div class="text-center mt-10">
        <a href="#catalogo" class="inline-flex items-center bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-8 rounded-lg transition-all glow">
        ...
        <div class="bg-blue-50 rounded-2xl p-8 md:p-10 custom-shadow">
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/4 mb-6 md:mb-0">
              <div class="w-32 h-32 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 flex items-center justify-center mx-auto custom-shadow">
  ...
  <!-- CTA -->
  <section class="py-16 bg-gradient-to-r from-blue-800 to-blue-600 text-white" id="registro">
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
          <a href="#registro" class="bg-white text-blue-800 hover:bg-blue-50 font-bold py-4 px-10 rounded-lg text-lg transition-all transform hover:scale-105 glow">
  ...
  <!-- Script menú hamburguesa (igual al tuyo) -->
  <script>
